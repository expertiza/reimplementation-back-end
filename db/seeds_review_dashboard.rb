...
Answer.create!(response_id: resp1.id, item_id: question.id, answer: 5, comments: "Excellent") unless Answer.exists?(response_id: resp1.id, item_id: question.id)
...
Answer.create!(response_id: resp2.id, item_id: question.id, answer: 3, comments: "Average") unless Answer.exists?(response_id: resp2.id, item_id: question.id)
