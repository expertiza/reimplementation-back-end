...
ActiveRecord::Schema[7.0].define(version: 2024_12_01_221122) do
  ...
  create_table "assignment_teams", charset: "utf8mb4", collation: "utf8mb4_0900_ai_ci", force: :cascade do |t|
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
  end
