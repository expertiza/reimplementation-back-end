    ...
    describe '#action_allowed' do
        context 'when the user is a Teaching Assistant' do
            it 'allows access to view_team to a TA' do
                ...
                get :action_allowed, params: { action: 'view_team' }
        ...
        context 'when the user is a Student' do
            ...
            #     # Ensure that s1 meets the criteria for 'view_my_scores'
            ...
            #     request.headers['Authorization'] = "Bearer #{student_token}"
            #     request.headers['Content-Type'] = 'application/json'
            #     get :action_allowed, params: { action: 'view_my_scores' }
            ...
            #     # Simulate conditions where the student can't view scores
