...
RSpec.describe 'api/v1/questionnaires', type: :request do
  path '/api/v1/questionnaires' do
    ...
    let(:instructor) do
      role
      Instructor.create(name: 'testinstructor', email: 'test@test.com', fullname: 'Test Instructor',
    ...
    post('create questionnaire') do
      ...
      let(:instructor) do
        role
        Instructor.create(id: 1, name: 'testinstructor', email: 'test@test.com', fullname: 'Test Instructor',
                          password: '123456', role:)
      end
