...
describe Questionnaire, type: :model do
  ...
  describe '.copy_questionnaire_details' do
    ...
    it 'creates a copy of the questionnaire' do
      ...
      question1.save!
      question2.save!
      copied_questionnaire = Questionnaire.copy_questionnaire_details( { id: questionnaire.id}, instructor.id)
    ...
    it 'creates a copy of all questions belonging to the original questionnaire' do
      ...
      question1.save!
      question2.save!
      copied_questionnaire = described_class.copy_questionnaire_details({ id: questionnaire.id }, instructor.id)
