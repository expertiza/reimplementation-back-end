describe AssignmentNode do
  describe '#self.table' do
	 it 'The code defines a class method called "table" that returns the string "assignments".'
  end
