...
describe 'AssignmentParticipant' do
    ...
    #   let(:user) { create(:user, name: "john", handle: nil) }
    #   let(:existing_participant) { create(:assignment_participant, handle: "jane_s") }
    #
    #   context "when user handle is nil or empty" do
    #     it "sets handle to user's name" do
    #       participant = create(:assignment_participant, user: user)
    #       participant.set_handle
    #       expect(participant.handle).to eq(user.name.downcase.delete(" \t\r\n"))
    #     end
    #   end
    #
    ...
    #       it "sets handle to user's name" do
    #         user_with_handle = create(:user, name: "jane", handle: "jane_s")
    #         existing_participant = create(:assignment_participant, user: user_with_handle )
    #
    #         participant = create(:assignment_participant, user: user)
    #         participant.set_handle
    #         expect(participant.handle).to eq(user.name.downcase.delete(" \t\r\n"))
    ...
    #         participant = create(:assignment_participant, user: user)
    #         participant.set_handle
    #         expect(participant.handle).to eq(user.handle.downcase)
    #       end
    #     end
    #   end
    # end
    #this test cases is to be reviewed by Devashish
