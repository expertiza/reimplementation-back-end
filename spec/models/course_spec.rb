...
describe Course, type: :model do
  ...
  let(:instructor) { Instructor.create(username: 'testinstructor', email: 'test@test.com', full_name: 'Test Instructor', password: '123456', role_id: role.id) }
  ...
  let(:user1) { create(:user, username: 'abcdef', full_name: 'abc bbc', email: 'abcbbc@gmail.com', password: '123456789', password_confirmation: '123456789', role: role) }
