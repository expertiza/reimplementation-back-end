...
#   let(:question) { build(:question) }
  ...
  describe '#edit' do
    it 'returns the html' do
      ...
      expect(multiple_choice_checkbox.edit).to eq('<tr><td><textarea cols="100" name="question[1][txt]" id="question_1_txt">Test text</textarea></td></tr><tr><td>Question Weight: <input type="number" name="question_weights[1][txt]" id="question_wt_1_txt" value="13" min="0" /></td></tr><tr><td><input type="hidden" name="quiz_question_choices[1][MultipleChoiceCheckbox][1][correct]" id="quiz_question_choices_1_MultipleChoiceCheckbox_1_correct" value="0" /><input type="checkbox" name="quiz_question_choices[1][MultipleChoiceCheckbox][1][correct]" id="quiz_question_choices_1_MultipleChoiceCheckbox_1_correct" value="1" checked="checked" /><input type="text" name="quiz_question_choices[1][MultipleChoiceCheckbox][1][txt]" id="quiz_question_choices_1_MultipleChoiceCheckbox_1_txt" value="question text" size="40" /></td></tr><tr><td><input type="hidden" name="quiz_question_choices[1][MultipleChoiceCheckbox][2][correct]" id="quiz_question_choices_1_MultipleChoiceCheckbox_2_correct" value="0" /><input type="checkbox" name="quiz_question_choices[1][MultipleChoiceCheckbox][2][correct]" id="quiz_question_choices_1_MultipleChoiceCheckbox_2_correct" value="1" checked="checked" /><input type="text" name="quiz_question_choices[1][MultipleChoiceCheckbox][2][txt]" id="quiz_question_choices_1_MultipleChoiceCheckbox_2_txt" value="question text" size="40" /></td></tr><tr><td><input type="hidden" name="quiz_question_choices[1][MultipleChoiceCheckbox][3][correct]" id="quiz_question_choices_1_MultipleChoiceCheckbox_3_correct" value="0" /><input type="checkbox" name="quiz_question_choices[1][MultipleChoiceCheckbox][3][correct]" id="quiz_question_choices_1_MultipleChoiceCheckbox_3_correct" value="1" checked="checked" /><input type="text" name="quiz_question_choices[1][MultipleChoiceCheckbox][3][txt]" id="quiz_question_choices_1_MultipleChoiceCheckbox_3_txt" value="question text" size="40" /></td></tr><tr><td><input type="hidden" name="quiz_question_choices[1][MultipleChoiceCheckbox][4][correct]" id="quiz_question_choices_1_MultipleChoiceCheckbox_4_correct" value="0" /><input type="checkbox" name="quiz_question_choices[1][MultipleChoiceCheckbox][4][correct]" id="quiz_question_choices_1_MultipleChoiceCheckbox_4_correct" value="1" checked="checked" /><input type="text" name="quiz_question_choices[1][MultipleChoiceCheckbox][4][txt]" id="quiz_question_choices_1_MultipleChoiceCheckbox_4_txt" value="question text" size="40" /></td></tr>')
    end
  end
