...
class VmQuestionResponse
    ...
    def initialize(questionnaire, assignment = nil, round = nil)
      ...
      @round = round
      if questionnaire.questionnaire_type == 'ReviewQuestionnaire'
      ...
      if @questionnaire_type == 'ReviewQuestionnaire'
        ...
        reviews.each do |review|
          ...
          if review_mapping.present?
            participant = Participant.find_by(user_id: review_mapping.reviewer_id)
    ...
    def add_answer(answer)
      ...
      @list_of_rows.each do |row|
        ...
        if answer.answer.is_a? Numeric
          color_code_number = ((answer.answer.to_f / question_max_score.to_f) * 5.0)
        ...
        tag_deps.each do |tag_dep|
          if (tag_dep.question_type == question.question_type) && (answer.comments.length > tag_dep.answer_length_threshold)
