...
module MailMixin
  ...
  # Send emails when a new submissions is added.
  def email(partial = 'new_submission')
    ...
    # Parent is used as a common variable name for either an assignment
    # or course depending on what the questionnaire is associated with
