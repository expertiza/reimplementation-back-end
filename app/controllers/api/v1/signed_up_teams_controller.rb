class Api::V1::SignedUpTeamsController < ApplicationController
  ...
  # Implemented by signed_up_team.rb (Model) --> sign_up_team_for_topic
  def create; end
  ...
  # Calls model method sign_up_team_for_topic
  def sign_up
    team_id = params[:team_id]
    topic_id = params[:topic_id]
    @signed_up_team = SignedUpTeam.sign_up_team_for_topic(topic_id, team_id)
    @signed_up_team.save
    if @signed_up_team
  ...
  # Call sign_up_team_for_topic Model method
  def sign_up_student
