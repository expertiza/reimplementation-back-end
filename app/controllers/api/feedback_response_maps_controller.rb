module Api
    ...
    class FeedbackResponseMapsController < ResponseMapsController
      ...
      # GET /feedback_response_maps/assignment/:assignment_id
      ...
      # GET /feedback_response_maps/reviewer/:reviewer_id
      ...
      # GET /feedback_response_maps/response_rate/:assignment_id
